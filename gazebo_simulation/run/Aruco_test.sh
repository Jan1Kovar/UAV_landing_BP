...
gzserver ${SCRIPT_DIR}/../world/Aruco_test.world --verbose &
sleep 5
gz model --spawn-file=${SCRIPT_DIR}/../models/Aruco_test/model.sdf --model-name=droneport1 -x 0.0 -y 0.0 -z 0.3 -Y 1.57
#sleep 2	
